...
Point::Point(double x, double y, double vx, double vy, double mass, double fx, double fy, int r, int g, int b) : m_x(x), m_y(y), m_vx(vx), m_vy(vy), m_mass(mass), m_fx(fx), m_fy(fy),
																																																								 m_r(r), m_g(g), m_b(b){
